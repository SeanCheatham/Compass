...
final class SharedCompassVMHeadlessFirstBootTests: XCTestCase {
    ...
    func testBootstrapScriptWaitsForOpendirectorydBeforeDsclWrites() {
        ...
        XCTAssertTrue(
            script.contains("/bin/launchctl bootstrap system /System/Library/LaunchDaemons/com.apple.opendirectoryd.plist"),
    ...
    func testBootstrapScriptGrantsGuestUserSSHAccessGroupMembership() {
        ...
        XCTAssertTrue(
            script.contains("/usr/sbin/dseditgroup -o edit -a \"$GUEST_USER\" -t user com.apple.access_ssh"),
    ...
    func testBootstrapScriptPlantsAutoLoginSoVMBootsStraightToDesktop() {
        ...
        XCTAssertTrue(
            script.contains("/usr/bin/defaults write /Library/Preferences/com.apple.loginwindow autoLoginUser"),
