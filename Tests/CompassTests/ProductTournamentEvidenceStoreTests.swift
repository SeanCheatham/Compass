...
struct ProductTournamentEvidenceStoreTests {
  ...
  @Test func planningDigestIncludesBoundedProductTournamentEvidence() throws {
    ...
    try #require(text.contains("Tournament automation proof scoreboard"))
    try #require(text.contains("top_action_status Blocked"))
  ...
  @Test func planAndReflectPromptsIncludeProductTournamentContextWithoutTranscripts() throws {
    ...
    for prompt in [plan, reflect] {
      ...
      try #require(prompt.contains("Tournament automation proof scoreboard"))
      try #require(prompt.contains("top_action_status Blocked"))
