...
extension CompassProject {
  fileprivate var reliabilityStatus: ProjectReliabilityStatus {
    ProjectReliabilityStatus(
      feedback: PlanReliabilityFeedback(state: state, sessions: sessions)
    )
  }

  fileprivate var sidebarStatus: ProjectSidebarStatus {
  ...
  fileprivate var storageAssessment: CompassWorkspaceStorageAssessment {
  ...
  fileprivate var storagePreflight: CompassWorkspaceStoragePreflight {
...
private func storageAssessmentColor(for severity: CompassWorkspaceStorageAssessment.Severity)
  -> Color
{
  switch severity {
  case .healthy:
