        ...
        TabView {
            Form {
                ...
                Section(header: Text("Model")) {
                    ...
                    .textFieldStyle(.roundedBorder)
                    .help("Used for any phase that has no override. Default: \(AgentRuntimeSettings.defaultModelIdentifier)")
                ...
                Section {
                    Text("These settings persist across launches. Environment variables `COMPASS_AGENT_BASE_URL`, `COMPASS_AGENT_API_KEY`, and `COMPASS_AGENT_MODEL[_PLAN/_DEV/_REFLECT]` seed empty fields on first launch.")
                        .font(.callout)
