...
public struct DraftRefinement: Equatable, Sendable {
  public enum Source: String, Equatable, Sendable {
    case generated
    case deterministic
  }

  public var originalDraft: String
  public var refinedText: String
  public var source: Source

  public init(originalDraft: String, refinedText: String, source: Source) {
...
public struct DraftRefinementContext: Equatable, Hashable, Sendable {
  public static let valueMaxCharacters = 160

  public var repoName: String
  public var immediatePlan: String
  ...
  public var noInventionSourceText: String {
    [
      repoName,
      immediatePlan,
      candidates,
...
public enum DraftRefinementService {
  ...
  public static func deterministicRefinement(
    draft: String,
    context: DraftRefinementContext
  ) -> DraftRefinement? {
    let trimmedDraft = normalizeDraft(draft)
  ...
  public static func parseGeneratedRefinement(
    _ raw: String,
    draft: String,
    context: DraftRefinementContext
  ) -> DraftRefinement? {
  ...
  public static func normalizeDraft(_ text: String) -> String {
