...
public final class LanguageRegistry: @unchecked Sendable {
  ...
  public func entry(for language: CodemapLanguage) -> Entry? {
    entries[language]
  }
  ...
  public static func symbolQuerySource(for language: CodemapLanguage) -> String {
    switch language {
