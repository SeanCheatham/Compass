...
/// and (eventually) over the macOS VM SSH route. Parsing itself runs
/// in-process — tree-sitter is fast enough that the IO dominates.
public struct CodemapIndexer: Sendable {
  ...
  public static let defaultParallelism = 8
  ...
  public let extractor: SymbolExtractor
  public let maxFileBytes: Int
  public let minFileBytes: Int
  public let walkCap: Int
  ...
  /// are pruned.
  public func indexAll() async throws -> Result {
  ...
  public func indexOne(relativePath: String) async -> PerFileOutcome {
  ...
  public func pruneEntries(notIn keep: Set<String>) -> Int {
    var pruned = 0
  ...
  public func listCandidateFiles() async throws -> [String] {
