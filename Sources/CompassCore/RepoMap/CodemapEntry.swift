...
package struct CodemapEntry: Codable, Sendable, Equatable {
  ...
  package var language: CodemapLanguage
  ...
  package var summaryContentHash: String?
  ...
  package var isGenerated: Bool
}

package enum CodemapHash {
  ...
  package static func sha256Hex(_ string: String) -> String {
