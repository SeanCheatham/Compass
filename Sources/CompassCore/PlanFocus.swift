...
/// over a run.
package enum PlanFocus: String, CaseIterable, Equatable {
  case feature
  case test
  case cleanup
  case docs
  ...
  package var promptGuidance: String {
  ...
  package static func weightedRandom<G: RandomNumberGenerator>(
  ...
  package static func weightedRandom() -> PlanFocus {
