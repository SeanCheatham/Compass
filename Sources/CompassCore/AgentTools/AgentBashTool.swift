...
package struct AgentBashTool: AgentTool {
  package static let toolName = "bash"
  package static let defaultTimeoutMs = 120_000
  package static let maxTimeoutMs = 1_800_000
  package static let maxOutputBytes = 100_000
  ...
  package static func isVerifyCommand(_ command: String) -> Bool {
  ...
  package func truncateOutput(_ text: String, label: String) -> String {
