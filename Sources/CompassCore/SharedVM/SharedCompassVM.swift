...
@MainActor
public final class SharedCompassVM: ObservableObject {
  // MARK: - Published state

  @Published public private(set) var readiness: SharedCompassVMReadiness = .notProvisioned
  ...
  @Published public private(set) var isShuttingDown: Bool = false
  ...
  public let bundle: SharedCompassVMBundle
  ...
  public static let shared: SharedCompassVM = {
    do {
  ...
  public static func makeDefault() throws -> SharedCompassVM {
