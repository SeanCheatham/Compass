...
package struct FileChange: Identifiable, Equatable {
  ...
  package let explanationReason: ExplainUnavailableReason?

  package var category: FileChangeCategory {
  ...
  package var lineCountLabel: String {
...
package enum FileChangeCategory: String, CaseIterable {
  case source = "Sources"
  case test = "Tests"
  case config = "Config"
  case other = "Other"
  ...
  package static func categorize(_ relativePath: String) -> FileChangeCategory {
...
package enum FileExplainer {
  ...
  ///   `reason` carries a user-facing message explaining why the feature
  ///   did not activate (e.g. `.foundationModelsUnavailable`).
  package static func whyGenerated(
    file relativePath: String,
    repoURL: URL,
    commits: [SessionCommit]
  ) async -> (String?, ExplainUnavailableReason?) {
  ...
  package static func changes(for repoURL: URL, commits: [SessionCommit]) async -> [FileChange] {
  ...
  package static func explainDiff(
    _ diff: String?,
  ...
  package static func parseGitDiffStat(_ diffStat: String) -> [FileChange] {
  ...
  package static func extractLineCounts(from statPart: String) -> (additions: Int, deletions: Int) {
  ...
  package static func gitDiffStat(sha: String, repoURL: URL) async -> String {
