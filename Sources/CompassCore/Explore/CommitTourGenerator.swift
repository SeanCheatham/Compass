...
public enum CommitTourGenerator {
  ...
  public static func generate(diff: String) async -> String? {
  ...
  public static func generateTour(commits: [SessionCommit], repoURL: URL) async -> String? {
