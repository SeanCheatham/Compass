...
public enum CommitExplainer {
  ...
  public static func summarize(diff: String) async -> (String?, ExplainUnavailableReason?) {
  ...
  public static func summarizeWhyGenerated(diff: String) async -> (String?, ExplainUnavailableReason?) {
  ...
  public static func gitDiff(sha: String, repoURL: URL, relativePath: String? = nil) async -> String {
    let trimmedSHA = sha.trimmingCharacters(in: .whitespacesAndNewlines)
  ...
  public static func gitDiffRange(
    newest: String,
    oldest: String,
    repoURL: URL,
  ...
  public static func commitDiffRange(
  ...
  /// is unavailable.
  public static func explain(commit: SessionCommit, repoURL: URL) async -> (
    String?, ExplainUnavailableReason?
  ) {
